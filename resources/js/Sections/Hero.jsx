...
import { Image, Divider, Button } from "@heroui/react";
                            ...
                            <div className="flex flex-col gap-0 justify-center items-center w-full md:items-start">
                                ...
                                <div className="hidden md:block">
                                    ...
                                    <p className="text-large text-foreground/80 text-justify">
                                        YUI is a lightweight Laravel installer
                                        for modern developers, featuring Laravel
                                        12, React 19 (JSX), Inertia.js,
                                        TailwindCSS 4, and Breeze for
                                        authentication. Pre-configured with
                                        Orion for REST APIs, TanStack Query for
                                        state management, and Laravel-permission
                                        for role handling. Optimized with Vite
                                        for fast builds and includes PHPUnit &
                                        Pest for testing. Get started in
                                        minutes! Let me know if you want any
                                        tweaks!
                                    </p>
                                </div>
                            </div>
